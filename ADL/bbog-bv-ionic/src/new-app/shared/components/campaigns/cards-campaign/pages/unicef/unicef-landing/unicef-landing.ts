...
@IonicPage()
@Component({
  selector: 'page-unicef-landing',
  templateUrl: 'unicef-landing.html',
})
export class UnicefLandingPage implements OnInit {

  private readonly UNICEF_EXTERNAL_URL = 'https://cambiandocontigo.co/';
  ...
  openModalTerms(): void {
    this.modalManagerProvider.showTYCCardModal('unicef');
  }
  ...
  private enroll(
    ...
    const request: EnrollCustomCardRq = {
      ...
      customCardSpecification: 'UNICEF_CARD',
    ...
    this.navCtrl.push('EnrollingPage', {data: 'unicef'});
  }
  ...
  public openUnicefExternalUrl(): void {
    window.open(this.UNICEF_EXTERNAL_URL, '_blank');
  }
}
