...
@IonicPage()
@Component({
  selector: 'page-pocket-withdraw-amount',
  templateUrl: 'pocket-withdraw-amount.html',
})
export class PocketWithdrawAmountPage {
  ...
  submit() {
    ...
    const pocket: Pocket = this.bdbInMemory.getItemByKey(InMemoryKeys.PocketWithdraw);
    ...
    pocketTransferRq.transferType = BdbConstants.POCKETS.withdraw;
