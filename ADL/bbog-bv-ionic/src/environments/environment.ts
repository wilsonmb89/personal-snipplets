...
export const ENV: Environment = {
  API_URL: 'https://api.bancodebogota.co/proxy-validator/',
  AUTH_URL: 'https://api.bancodebogota.co/pb-authorizer/',
  ...
  API_AUTH_INTEGRATION: 'https://api.bancodebogota.co/auth/',
  ...
  STREAM_NAME: 'yb-analytics-pro-pb-kns-stream',
  ...
  INJECTABLE_SCRIPTS_KEYS: {
    ...
    CYXTERA_SCRIPT_CI: '7eaf56de-6b76-42b6-8a2e-71f6534a1614',
    CYXTERA_SCRIPT_WI: '1573',
    GTM_ID: 'GTM-PSCQRNP'
  },
